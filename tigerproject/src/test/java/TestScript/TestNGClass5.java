...
public class TestNGClass5 extends BaseTest{
	@Test
	public void TC_10() throws Exception{
		...
		//===========================================================================================================================
		//step 6:Click on Look up image beside List Price and select price book and Enter QTY and click on save
		...
		invoicepage.getQuantityTextField().sendKeys(lib.getValueinString("./Resources/data.xlsx", "Sheet1", 9, 0),Keys.TAB);
		if(invoicepage.getErrorMesg().isDisplayed()){
			Reporter.log("Error Message Stock Is Not Enough is displayed successfully",true);
		}else{
			Reporter.log("Error Message Stock Is Not Enough is not displayed ",true);
		}
	}
}
